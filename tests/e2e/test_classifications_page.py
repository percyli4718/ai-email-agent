...
def test_classifications_page_loads(page: Page, base_url: str):
    """测试分类页面加载"""
    page.goto(f"{base_url}/#/classifications")
...
def test_filter_type_dropdown(page: Page, base_url: str):
    """测试类型过滤下拉框"""
    page.goto(f"{base_url}/#/classifications")
...
def test_filter_urgency_dropdown(page: Page, base_url: str):
    """测试紧急程度过滤下拉框"""
    page.goto(f"{base_url}/#/classifications")
...
def test_filter_route_dropdown(page: Page, base_url: str):
    """测试路由类型过滤下拉框"""
    page.goto(f"{base_url}/#/classifications")
...
def test_classification_cards_display(page: Page, base_url: str):
    """测试分类卡片展示"""
    page.goto(f"{base_url}/#/classifications")
...
def test_classification_detail_modal(page: Page, base_url: str):
    """测试分类详情弹窗"""
    page.goto(f"{base_url}/#/classifications")
...
def test_filter_type_change(page: Page, base_url: str):
    """测试类型过滤功能"""
    page.goto(f"{base_url}/#/classifications")
...
def test_empty_state_display(page: Page, base_url: str):
    """测试空状态显示"""
    # 这个测试假设在没有数据时的表现
    page.goto(f"{base_url}/#/classifications")
...
def test_page_responsive_layout(page: Page, base_url: str):
    """测试页面响应式布局"""
    # 测试不同视口大小
    viewports = [
